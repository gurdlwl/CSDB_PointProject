    ...
    public partial class AddMinusPoint : Form
    {
        ...
        private bool TxtCheck()
        {
            ...
            if (this.txtStuId.Text == "")
                ...
                str = "이름";
            else if (this.udMP.Value.ToString() == "")
                str = "벌점";
            else if (this.txtMPReason.Text == "")
                str = "사유";
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            if (TxtCheck() == true)
            {
                ...
                //String Sql = "update student set minusPoint = minusPoint-";
                String Sql = "update student set minusPoint = ";
                Sql += udMP.Value.ToString();
